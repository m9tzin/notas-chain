...
func (c *NotaContract) UpdateNota(ctx contractapi.TransactionContextInterface, id string, aluno string, disciplina string, data string, nota float64) error {
	...
	notaAtualizada := Nota{
		...
		Nota:       nota,
		Data:       data, // Adicionado campo Data
	}
